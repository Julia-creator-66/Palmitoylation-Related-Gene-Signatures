...
setwd("C:\\Users\\Administrator\\Desktop\\Exosome\\11.GO")      #设置工作目录
rt=read.table("Exosome.diffGenes.txt", header=T, sep="\t", check.names=F)     #读取差异外泌体基因的列表文件
...
cnet=cnetplot(kk, layout=igraph::layout_in_circle, showCategory=10, foldChange=2^logFC)
print(cnet)
dev.off()
