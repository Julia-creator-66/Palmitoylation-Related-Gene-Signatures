...
setwd("E:\\F盘\\5.桌面文件\\3.私人资料\\论文第七次修改\\导入github的数据R语言（R4.4.3）\\12.KEGG(xiugai)")      #设置工作目录
rt=read.table("Palmitoylation.diffGenes.txt", header=T, sep="\t", check.names=F)     #读取基因列表文件
...
#绘制通路图
keggId="hsa05144"      #输入通路ID，进行通路图的绘制(需要修改)
